...
def LaneLine_process(image):
    ...
    lane_images = draw_lane_lines(image1, lane_lines(image, list_of_lines),color=(255, 255, 0))
    return lane_images
...
if __name__ == '__main__':
    import cv2
    image = cv2.imread('video_analysis/10.jpg')
    show_image(LaneLine_process(image))